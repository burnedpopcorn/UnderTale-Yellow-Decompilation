var play_time, string_minutes, string_seconds;
...
with (other)
{
    ...
    if (room == rm_mainmenu)
    {
        ...
        draw_text(__view_get(e__VW.XView, 0) + 85, 160, string_hash_to_newline("Continue"));
        draw_set_color(c_white);
        
        if (p[2] == true)
            draw_set_color(c_yellow);
        
        draw_text(__view_get(e__VW.XView, 0) + 175, 160, string_hash_to_newline("Reset"));
        draw_set_color(c_white);
        ...
        draw_text(__view_get(e__VW.XView, 0) + 160, 160, string_hash_to_newline("Config"));
        draw_set_color(c_white);
        draw_set_color(c_white);
        draw_set_halign(fa_left);
        ini_open("Save.sav");
